...
\comment{talk about JavaScript execution time revisited for mobisys12}
...
\comment{add web browsing in LTE networks, leave the discussion of power till later. Talk about the time 2009 v.s. 2011, longitudinal study of web browsing performance.}

%sum for Web browsing section
\paragraph{Summary:} 
\comment{update summary based on results from mobisys12}
