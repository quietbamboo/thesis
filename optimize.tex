...
In this chapter, we present the design of \NAME in \S\ref{sec:overview}. Then we explore feature selection in \S\ref{sec:stats}. With the methodology discussed in \S\ref{sec:method}, we evaluate the performance of \NAME in \S\ref{sec:evaluation}. We summarize related work in \S\ref{sec:related}, before concluding in \S\ref{sec:conc}.
