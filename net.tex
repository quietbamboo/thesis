...
\end{tabular}
\ncaption{TCP performance comparison among carriers (data from deployed application \mobiperf, considering only U.S.)}
...
\end{tabular}
\ncaption{Correlation between TCP performance and time of day
  \emph{(3GTest-Local)}} \label{fig:net.tod}
\end{figure*}
